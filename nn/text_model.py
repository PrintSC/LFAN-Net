...
try:
    ...
    checks.check_requirements("git+https://github.com/lfan/CLIP.git")
    import clip
...
class CLIP(TextModel):
    ...
    def encode_image(self, image: Union[Image.Image, torch.Tensor], dtype: torch.dtype = torch.float32) -> torch.Tensor:
        ...
        Examples:
            >>> from nn.text_model import CLIP
            >>> from PIL import Image
            >>> clip_model = CLIP("ViT-B/32", device="cuda")
...
class MobileCLIP(TextModel):
    ...
    def __init__(self, size: str, device: torch.device) -> None:
        ...
        try:
            ...
            checks.check_requirements("git+https://github.com/lfan/mobileclip.git")
            import mobileclip
