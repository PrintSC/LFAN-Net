...
from hub.utils import HELP_MSG, HUB_WEB_ROOT, PREFIX
from utils import IS_COLAB, LOGGER, SETTINGS, TQDM, checks, emojis
...
class HUBTrainingSession:
    ...
    def __init__(self, identifier: str):
        ...
        self.timers = {}  # holds timers in lfan/utils/callbacks/hub.py
        self.model = None
        self.model_url = None
