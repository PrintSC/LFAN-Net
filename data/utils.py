...
def check_cls_dataset(dataset: Union[str, Path], split: str = "") -> Dict[str, Any]:
    ...
    if not train_set.is_dir():
        ...
        if image_files:
            from data.split import split_classify_dataset
...
class HUBDatasetStats:
    ...
    Note:
        Download *.zip files from https://github.com/lfan/hub/tree/main/example_datasets
        i.e. https://github.com/lfan/hub/raw/main/example_datasets/coco8.zip for coco8.zip.
    ...
    def get_json(self, save: bool = False, verbose: bool = False) -> Dict:
        ...
        for split in "train", "val", "test":
            ...
            if self.task == "classify":
                from torchvision.datasets import ImageFolder  # scope for faster 'import lfan'
    ...
    def process_images(self) -> Path:
        ...
        from data import YOLODataset  # ClassificationDataset
...
def compress_one_image(f: str, f_new: str = None, max_dim: int = 1920, quality: int = 50):
    ...
    Examples:
        >>> from pathlib import Path
        >>> from data.utils import compress_one_image
