...
from utils import DATASETS_DIR, LOGGER, NUM_THREADS, TQDM
from utils.downloads import download, zip_directory
...
def convert_coco(
    ...
    Examples:
        >>> from data.converter import convert_coco
...
def convert_segment_masks_to_yolo_seg(masks_dir: str, output_dir: str, classes: int):
    ...
    Examples:
        >>> from data.converter import convert_segment_masks_to_yolo_seg
...
def convert_dota_to_yolo_obb(dota_root_path: str):
    ...
    Examples:
        >>> from data.converter import convert_dota_to_yolo_obb
...
def create_synthetic_coco_dataset():
    ...
    Examples:
        >>> from data.converter import create_synthetic_coco_dataset
