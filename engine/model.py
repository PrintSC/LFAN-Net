...
class Model(torch.nn.Module):
    ...
    def __init__(
        ...
        if self.is_hub_model(model):
            from hub import HUBTrainingSession
    ...
    def __call__(
        ...
        **kwargs: Any,
        ...
        Returns:
            (List[engine.results.Results]): A list of prediction results, each encapsulated in a
                Results object.
    ...
    def predict(
        ...
        **kwargs: Any,
        ...
        is_cli = (ARGV[0].endswith("lfan") or ARGV[0].endswith("yolo")) and any(
    ...
    def track(
        ...
        **kwargs: Any,
        ...
        Returns:
            (List[engine.results.Results]): A list of tracking results, each a Results object.
    ...
    def val(
        ...
        **kwargs: Any,
        ...
        Args:
            validator (engine.validator.BaseValidator, optional): An instance of a custom validator class
                for validating the model.
            **kwargs (Any): Arbitrary keyword arguments for customizing the validation process.

        Returns:
            (utils.metrics.DetMetrics): Validation metrics obtained from the validation process.
    ...
    def benchmark(self, data=None, format="", verbose=False, **kwargs: Any):
        ...
        It uses the 'benchmark' function from the utils.benchmarks module. The benchmarking is
    ...
    def tune(
        ...
        **kwargs: Any,
        ...
        When Ray Tune is enabled, it leverages the 'run_ray_tune' function from the utils.tuner module.
    ...
    def names(self) -> Dict[int, str]:
        ...
        using the 'check_class_names' function from the nn.autobackend module. If the predictor is not
