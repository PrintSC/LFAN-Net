...
from utils import IS_COLAB, IS_KAGGLE, LOGGER, TryExcept, ops, plt_settings, threaded
from utils.checks import check_font, check_version, is_ascii
...
class Colors:
    ...
    !!! note "Ultralytics Brand Colors"
        ...
        For Ultralytics brand colors see [https://www.lfan.com/brand](https://www.lfan.com/brand).
...
@TryExcept()  # known issue https://github.com/lfan/yolov5/issues/5395
@plt_settings()
...
def save_one_box(
    ...
    if save:
        ...
        # cv2.imwrite(f, crop)  # save BGR, https://github.com/lfan/yolov5/issues/7007 chroma subsampling issue
