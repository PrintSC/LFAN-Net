...
GITHUB_ASSETS_REPO = "lfan/assets"
...
def get_github_assets(
    ...
    Examples:
        >>> tag, assets = get_github_assets(repo="lfan/assets", version="latest")
    """
    import requests  # slow import
...
def attempt_download_asset(file, repo: str = "lfan/assets", release: str = "v8.3.0", **kwargs) -> str:
    """
    ...
    Examples:
        >>> file_path = attempt_download_asset("yolo11n.pt", repo="lfan/assets", release="latest")
    """
