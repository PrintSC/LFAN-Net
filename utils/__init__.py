...
from utils.patches import imread, imshow, imwrite, torch_save  # for patches
...
class DataExportMixin:
    ...
    def to_df(self, normalize=False, decimals=5):
        ...
        """
        import pandas as pd  # scope for faster 'import lfan'
...
class IterableSimpleNamespace(SimpleNamespace):
    ...
    def __getattr__(self, attr):
        ...
        raise AttributeError(
            ...
            https://github.com/ultralytics/ultralytics/blob/main/cfg/default.yaml
            """
        )
...
def plt_settings(rcparams=None, backend="Agg"):
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            import matplotlib.pyplot as plt  # scope for faster 'import lfan'
...
def is_user_default(args, DEFAULT_CFG_DICT):
    flag = args.config
    if flag:
        args_dict = vars(args)
        if 'config' in args_dict:
            ...
            print("=" * 100)
            DEFAULT_CFG_DICT = args_dict
    if flag:
        print(f"\033[1;32mconfig_path:\033[0m config_file is {flag}, load the argparse.Namespace")
    return DEFAULT_CFG_DICT


DEFAULT_CFG_DICT = is_user_default(args, DEFAULT_CFG_DICT)
...
def vscode_msg(ext="lfan.ultralytics-snippets") -> str:
