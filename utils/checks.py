    ...
    if ONLINE and IS_PIP_PACKAGE:
        try:
            ...
            if check_version(__version__, f"<{latest}"):  # check if current version is < latest version
                LOGGER.info(
                    f"New https://pypi.org/project/lfan/{latest} available 😃 "
...
def check_font(font="Arial.ttf"):
    ...
    """
    from matplotlib import font_manager  # scope for faster 'import lfan'
        ...
        if "u.yaml" in file:
            ...
            if file != original_file and verbose:
                LOGGER.info(
                    ...
                    f"standard YOLOv5 models trained with https://github.com/lfan/yolov5.\n"
                )
    return file
