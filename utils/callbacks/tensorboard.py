...
from utils import LOGGER, SETTINGS, TESTS_RUNNING, colorstr, torch_utils
...
def _log_tensorboard_graph(trainer) -> None:
    ...
    Args:
        trainer (engine.trainer.BaseTrainer): The trainer object containing the model to visualize.
