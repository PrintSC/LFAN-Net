...
from utils.metrics import ClassifyMetrics, DetMetrics, OBBMetrics, PoseMetrics, SegmentMetrics
...
def _fetch_trainer_metadata(trainer) -> dict:
    ...
    Args:
        trainer (engine.trainer.BaseTrainer): The YOLO trainer object containing training state and config.
...
def _log_plots(experiment, trainer) -> None:
    ...
    Args:
        ...
        trainer (engine.trainer.BaseTrainer): The trainer object containing validation metrics and save
            directory information.

    Examples:
        >>> from utils.callbacks.comet import _log_plots
