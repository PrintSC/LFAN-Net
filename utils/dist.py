...
def generate_ddp_file(trainer):
    ...
    Args:
        trainer (engine.trainer.BaseTrainer): The trainer containing training configuration and arguments.
...
def generate_ddp_command(world_size: int, trainer):
    ...
    Args:
        ...
        trainer (engine.trainer.BaseTrainer): The trainer containing configuration for distributed training.
...
def ddp_cleanup(trainer, file):
    ...
    Args:
        trainer (engine.trainer.BaseTrainer): The trainer used for distributed training.
